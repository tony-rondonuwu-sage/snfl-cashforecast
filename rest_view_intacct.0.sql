   ...
   CREATE OR REPLACE SECURE VIEW ACCOUNTS_PAYABLE_RECURRING_BILL
    COMMENT =  "Version=fddf114a-df72-446f-b71f-5b22ea7ae5b2 " 
    AS SELECT 
 ...
 FROM  DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_recurbillscheduledop  accounts_payable_recurring_bill 
  
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_TERM term ON term.record_ = accounts_payable_recurring_bill.termkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_LOCATION melocation ON melocation.record_ = accounts_payable_recurring_bill.locationkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_vendor vendor ON vendor.entity = accounts_payable_recurring_bill.record_ 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_schedule schedule ON schedule.record_ = accounts_payable_recurring_bill.schopkey 
 ...
 FROM  DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_prrecord  accounts_payable_payment 
  
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_userinfo audit_createdbyuser ON audit_createdbyuser.record_ = accounts_payable_payment.createdby 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_userinfo audit_modifiedbyuser ON audit_modifiedbyuser.record_ = accounts_payable_payment.modifiedby 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_LOCATION melocation ON melocation.record_ = accounts_payable_payment.locationkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_EXCHANGERATEINFO exchangerateinfo ON exchangerateinfo.recordkey = accounts_payable_payment.record_ 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_TAXSOLUTION taxsolution ON taxsolution.record_ = accounts_payable_payment.taxsolutionkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_vendor vendor ON vendor.record_ = accounts_payable_payment.vendorkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_PRBATCH batch ON batch.record_ = accounts_payable_payment.prbatchkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_CONTACTVERSION payto ON payto.record_ = accounts_payable_payment.billtopaytokey 
 ...
 FROM  DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_prentry  accounts_payable_payment_line 
  
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_userinfo audit_createdbyuser ON audit_createdbyuser.record_ = accounts_payable_payment_line.createdby 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_userinfo audit_modifiedbyuser ON audit_modifiedbyuser.record_ = accounts_payable_payment_line.modifiedby 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_class dimensions_class ON dimensions_class.record_ = accounts_payable_payment_line.classdimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_contract dimensions_contract ON dimensions_contract.record_ = accounts_payable_payment_line.contractdimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_costtype dimensions_costtype ON dimensions_costtype.record_ = accounts_payable_payment_line.costtypedimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_customer dimensions_customer ON dimensions_customer.record_ = accounts_payable_payment_line.customerdimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_department dimensions_department ON dimensions_department.record_ = accounts_payable_payment_line.dept_ 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_employee dimensions_employee ON dimensions_employee.record_ = accounts_payable_payment_line.employeedimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_icitem dimensions_item ON dimensions_item.record_ = accounts_payable_payment_line.itemdimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_location dimensions_location ON dimensions_location.record_ = accounts_payable_payment_line.location_ 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_project dimensions_project ON dimensions_project.record_ = accounts_payable_payment_line.projectdimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_task dimensions_task ON dimensions_task.record_ = accounts_payable_payment_line.taskdimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_vendor dimensions_vendor ON dimensions_vendor.record_ = accounts_payable_payment_line.vendordimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_icwarehouse dimensions_warehouse ON dimensions_warehouse.record_ = accounts_payable_payment_line.warehousedimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_GLACCOUNT glaccount ON glaccount.record_ = accounts_payable_payment_line.accountkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_CONTACT contact ON contact.record_ = dimensions_employee.contactkey AND dimensions_employee.record_ = accounts_payable_payment_line.employeedimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_TAXDETAIL detail ON detail.record_ = accounts_payable_payment_line.taxdetail_ 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_prrecord accounts_payable_payment ON accounts_payable_payment.recordtype in ('pp','pr') 
 ...
 FROM  DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_operation  core_operation 
  ...
  ;   
   ...
   CREATE OR REPLACE SECURE VIEW GENERAL_LEDGER_JOURNAL_ENTRY_LINE
    COMMENT =  "Version=fddf114a-df72-446f-b71f-5b22ea7ae5b2 " 
    AS SELECT 
    GENERAL_LEDGER_JOURNAL_ENTRY_LINE.UDDREL3 as GLDIMORGANIZATION, GENERAL_LEDGER_JOURNAL_ENTRY_LINE.UDDREL2 as GLDIMPRODUCT_LINE_FAMILY, GENERAL_LEDGER_JOURNAL_ENTRY_LINE.UDDREL1 as GLDIMEND_CUSTOMER , 
 	-- 	end custom fields 
 ...
 FROM  DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_apterm  accounts_payable_term 
  ...
  ;   
   ...
   CREATE OR REPLACE SECURE VIEW GENERAL_LEDGER_BUDGET_DETAIL
    COMMENT =  "Version=fddf114a-df72-446f-b71f-5b22ea7ae5b2 " 
    AS SELECT 
    GENERAL_LEDGER_BUDGET_DETAIL.UDDREL2 as GLDIMPRODUCT_LINE_FAMILY, GENERAL_LEDGER_BUDGET_DETAIL.UDDREL1 as GLDIMEND_CUSTOMER, GENERAL_LEDGER_BUDGET_DETAIL.UDDREL3 as GLDIMORGANIZATION , 
 	-- 	end custom fields 
 ...
 FROM  DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_location  company_config_location 
  ...
  ;   
   ...
   CREATE OR REPLACE SECURE VIEW ACCOUNTS_RECEIVABLE_CUSTOMER
    COMMENT =  "Version=fddf114a-df72-446f-b71f-5b22ea7ae5b2 " 
    AS SELECT 
    ACCOUNTS_RECEIVABLE_CUSTOMER.custfield21 as CNS_REASON, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield4 as CPA_VAR, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield29 as UP_PAYMENT_PROVIDER_CUSTOMER_ID, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield20 as CNS_TO, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield8 as CUSTOMER_SUPPORT_LEVEL, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield9 as CUSTOMER_TIER, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield14 as CNS_PROMISE_TO_PAY_DATE, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield25 as OTHER_TAX_ID, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield19 as CNS_FROM, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield10 as ACCOUNT_OWNER, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield18 as CNS_EXCLUDE_FROM_AUTO_NOTICES, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield24 as VAT_NUMBER, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield13 as CNS_CUSTOMER_RATING, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield22 as INTACCT_ENTITY, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield11 as ACH_ON_FILE, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield26 as COMMUNICATION_PREFERENCE, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield6 as CUSTOMER_HEALTH, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield17 as CNS_LANGUAGE, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield23 as INTACCT_LOCATION, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield5 as CREDIT_CARD_ON_FILE, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield27 as ACCOUNT_OWNER_EMAIL, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield3 as COMMENTS_CUSTOM, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield16 as CNS_STATEMENTS_CONTACT, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield28 as UP_SYNC_TO_PAYMENT_PROVIDER, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield7 as CUSTOMER_SEGMENT, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield15 as CNS_COLLECTIONS_CONTACT, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield2 as BPO_AICPA_STATUS, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield1 as PAYMENT_METHOD, ACCOUNTS_RECEIVABLE_CUSTOMER.custfield12 as PARTNER_PARENT , 
 	-- 	end custom fields 
 ...
 FROM  DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_recurprentry  accounts_payable_recurring_bill_line 
  
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_userinfo audit_createdbyuser ON audit_createdbyuser.record_ = accounts_payable_recurring_bill_line.createdby 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_userinfo audit_modifiedbyuser ON audit_modifiedbyuser.record_ = accounts_payable_recurring_bill_line.modifiedby 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_class dimensions_class ON dimensions_class.record_ = accounts_payable_recurring_bill_line.classdimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_contract dimensions_contract ON dimensions_contract.record_ = accounts_payable_recurring_bill_line.contractdimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_costtype dimensions_costtype ON dimensions_costtype.record_ = accounts_payable_recurring_bill_line.costtypedimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_customer dimensions_customer ON dimensions_customer.record_ = accounts_payable_recurring_bill_line.customerdimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_department dimensions_department ON dimensions_department.record_ = accounts_payable_recurring_bill_line.dept_ 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_employee dimensions_employee ON dimensions_employee.record_ = accounts_payable_recurring_bill_line.employeedimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_icitem dimensions_item ON dimensions_item.record_ = accounts_payable_recurring_bill_line.itemdimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_location dimensions_location ON dimensions_location.record_ = accounts_payable_recurring_bill_line.location_ 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_project dimensions_project ON dimensions_project.record_ = accounts_payable_recurring_bill_line.projectdimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_task dimensions_task ON dimensions_task.record_ = accounts_payable_recurring_bill_line.taskdimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_vendor dimensions_vendor ON dimensions_vendor.record_ = accounts_payable_recurring_bill_line.vendordimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_icwarehouse dimensions_warehouse ON dimensions_warehouse.record_ = accounts_payable_recurring_bill_line.warehousedimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_GLACCOUNT offsetglaccountno ON offsetglaccountno.record_ = accounts_payable_recurring_bill_line.gloffset 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_ACCOUNTLABEL apaccountlabel ON apaccountlabel.record_ = accounts_payable_recurring_bill_line.accountlabelkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_ALLOCATION alloc ON alloc.record_ = accounts_payable_recurring_bill_line.allocationkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_GLACCOUNT glaccount ON glaccount.record_ = accounts_payable_recurring_bill_line.accountkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_CONTACT contact ON contact.record_ = dimensions_employee.contactkey AND dimensions_employee.record_ = accounts_payable_recurring_bill_line.employeedimkey 
 	LEFT JOIN DATA_SHARE_SAGE.SIF_CLIENT_VIEWS.V_CLI_recurprrecord aprecurbill ON aprecurbill.record_ = accounts_payable_recurring_bill_line.recordkey AND aprecurbill.recordtype = 'pi' 
